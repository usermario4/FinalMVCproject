					...
					<ul class="nav nav-pills nav-sidebar flex-column"
						...
						<li class="nav-item menu-open"><a href="#"
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a href="${pageContext.request.contextPath}/hikers/all" class="nav-link active">
										<i class="far fa-circle nav-icon"></i>
										<p>Hikers</p>
								</a></li>
								<li class="nav-item"> 
								<a href="${pageContext.request.contextPath}/trails/all" class="nav-link active"> <i
										class="far fa-circle nav-icon"></i>
										<p>Trails</p>
								</a></li>
								<li class="nav-item"><a href="${pageContext.request.contextPath}/events/all" class="nav-link active"> <i
										class="far fa-circle nav-icon"></i>
										<p>Events</p>
								</a></li>
							</ul>
					...
					<div class="row">
						...
						<section class="col-lg-7 connectedSortable">
							<div class="card-tools">
										...
										<c:forEach var="event" items="${event}" varStatus="idx">
											<tr
												...
												<td>
													<table>
														<tr>
															<td><a href="<c:url value='/events/${event.id}' />">DETAILS</a></td>
															<td style="border-left: 1px solid white;"><a
																href="<c:url value='/events/edit/${event.id}' />">EDIT</a></td>
															<td style="border-left: 1px solid white;"><a
																href="<c:url value='/events/delete/${event.id}' />">DELETE</a></td>
														</tr>
													</table>
												</td>
								...
								<a href="<c:url value='/events/create' />">
