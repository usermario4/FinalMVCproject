               ...
               with font-awesome or any other icon font library -->
						<li class="nav-item menu-open"><a href="#"
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a href="${pageContext.request.contextPath}/hikers/all" class="nav-link active"> <i class="far fa-circle nav-icon"></i>
										<p>Hikers</p>
								</a></li>
								<li class="nav-item"><a href="${pageContext.request.contextPath}/trails/all" class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>Trails</p>
								</a></li>
								<li class="nav-item"><a href="${pageContext.request.contextPath}/events/all" class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>Events</p>
								</a></li>
							</ul>
				</nav>
...
<table>
 <thead>
        <tr>
            ...
            <th style="border: 1px solid black;">CNP</th>
            <th style="border: 1px solid black;">Entry Date</th>
            <th style="border: 1px solid black;">Exit date</th>
             <th style="border: 1px solid black;">Trail Name</th>
            <th style="border: 1px solid black;">Phone number</th>
            <th style="border: 1px solid black;">Actions</th>
        </tr>
    </thead>
    <tbody>
<c:forEach var="hiker" items="${hiker}" varStatus="idx">
<tr ${idx.index%2==0? "style='background-color:grey;color:white'":" "}>

<td style="border: 1px solid black;"><c:out value="${hiker.hiker_ID}"/></td>
<td style="border: 1px solid black;"><c:out value="${hiker.full_name}"/></td>
<td style="border: 1px solid black;"><c:out value="${hiker.age}"/></td>
<td style="border: 1px solid black;"><c:out value="${hiker.CNP}"/></td>
<td style="border: 1px solid black;"><c:out value="${hiker.entry_date}"/></td>
<td style="border: 1px solid black;"><c:out value="${hiker.exit_date}"/></td>
<td style="border: 1px solid black;"><c:out value="${hiker.trail_name}"/></td>
<td style="border: 1px solid black;"><c:out value="${hiker.phone_number}"/></td>

<td>
<table>
<tr >
<td><a href="<c:url value="/hikers/${hiker.hiker_ID}"/>">DETAILS</a></td>
<td style="border-left: 1px solid white;"><a href="<c:url value="/hikers/edit/${hiker.hiker_ID}"/>">EDIT</a></td>
<td style="border-left: 1px solid white;"><a href="<c:url value="/hikers/delete/${hiker.hiker_ID}"/>">DELETE</a></td>
</tr>
</table>
...
<a href="<c:url value='/hikers/create' />">
                <button type="button">Create Hiker</button>
            </a>
 <!-- SCRIPTS -->
