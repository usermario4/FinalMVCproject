...
<body>
    <h1>Edit Trail</h1>
    <form:form method="post" action="${pageContext.request.contextPath}/trails/edit" modelAttribute="trail">
        <form:input path="trail_id" readOnly="true" type="text" name="trail_id" class="form-control" placeholder="Trail ID" />
        
        <label for="name">Name</label>
        <form:input path="name" type="text" required="required" />
        
        <label for="distance">Distance</label>
        <form:input path="distance" type="number" required="required" />
        
        <label for="safe_house">Safe houses</label>
        <form:input path="safe_house" type="number" required="required" />

        <input type="submit" value="Save" /><br/>
    </form:form>

    <a href="${pageContext.request.contextPath}/trails/all" class="back-button">
