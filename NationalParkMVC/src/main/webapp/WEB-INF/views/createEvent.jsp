...
<p>Insert Event:</p>
<form action="${pageContext.request.contextPath}/events/create" method="post" style="display: flex; flex-direction: column; max-width: 300px; margin: 0 auto;">
...
<a href="${pageContext.request.contextPath}/events/all">
